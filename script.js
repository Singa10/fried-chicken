...
: header.classList.remove('shadow-header')
  ...
  sr.reveal(`.home-data`,{delay:1000})
  ...
  sr.reveal(`.menu1`,{delay:600, origin:'right'})
  sr.reveal(`.menu2`,{delay:700, origin:'left'})
  sr.reveal(`.menu3`,{delay:800, origin:'right'})
  sr.reveal(`.menu4`,{delay:900, origin:'left'})
  sr.reveal(`.menu5`,{delay:1000, origin:'right'})
  sr.reveal(`.menu6`,{delay:1100, origin:'left'})
  sr.reveal(`.menu7`,{delay:1200, origin:'right'})
  sr.reveal(`.menu8`,{delay:1300, origin:'left'})
